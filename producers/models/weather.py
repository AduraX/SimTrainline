...
class Weather(Producer):
    ...
    def __init__(self, month):
        ...
        topic_name = "Chicago_Station_Weather"
        super().__init__(
    ...
    def run(self, month):
        ...
        resp = requests.post(
            ...
            data=json.dumps({
                "key_schema": json.dumps(Weather.key_schema), #Weather.key_schema,
                "value_schema": json.dumps(Weather.value_schema), # Weather.value_schema,
                "records": [{
